...
--Retrieve the employee info from Retire Titles table
SELECT emp_no, first_name, last_name, title
FROM retire_titles;
-- Use Dictinct with Orderby to remove duplicate rows
SELECT DISTINCT ON (emp_no) retire_titles.emp_no,
first_name,
last_name,
title
INTO unique_titles
...
--Deliverable 2
--Create a table for employees who are eligible for mentorship program
